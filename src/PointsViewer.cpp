...
void PointsViewer::addPoints(std::vector<std::array<double, nDim>> inPoints)
{
...
void PointsViewer::setColours(std::vector<std::string> inColours)
{
...
int PointsViewer::size()
{
	return points.size();
}

void PointsViewer::clearAllPoints()
{
	points.clear();
}

int PointsViewer::run()
{
	// Load point data
